...
- Indexes classic CBH databases, unencrypted CBV archives, and PGN files into their own named collections, with duplicate-source detection. Retains standard moves, variations, text comments and NAGs; preserves board markings as annotation text. See README for format and size limits.
...
- Imports weekly TWIC archives and public Lichess games, players, studies, or broadcast rounds into named collections by default or a collection explicitly chosen in the import dialog, with duplicate skipping and player-history filters.
